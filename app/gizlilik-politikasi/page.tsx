...
export default function GizlilikPolitikasiPage() {
    ...
    const tocItems = [
        ...
        { id: 'veri-guvenligi', label: '8. Veri GüvenliÃ„şi', icon: <Lock size={15} /> },
        ...
        { id: 'cocuk-gizlilik', label: '11. Çocukların GizliliÃ„şi', icon: <Shield size={15} /> },
            ...
            <main style={{
                ...
                <div style={{
                    ...
                    <p style={{ fontSize: '17px', color: 'var(--text-muted)', maxWidth: '600px', margin: '0 auto', lineHeight: 1.6 }}>
                        Kişisel verilerinizin korunması bizim en önemli önceliÃ„şimizdir.
                    ...
                    <article style={{
                        ...
                        <div className="legal-highlight" style={{
                            ...
                            <span style={{ color: 'var(--text-muted)' }}>
                                Bu Gizlilik Politikası, 6698 Sayılı Kişisel Verilerin Korunması Kanunu (&quot;KVKK&quot;) m.10 uyarınca hazırlanan aydınlatma yükümlülüÃ„şünü yerine getirmektedir.
                                Ayrıca AB Genel Veri Koruma TüzüÃ„şü (GDPR) ilkelerine de uyum saÃ„şlamaktadır.
                            </span>
                        </div>
                        ...
                        <div data-section="veri-sorumlusu" className="legal-section">
                            ...
                            <p className="legal-p">
                                KVKK m.3/ı uyarınca, kişisel verilerinizin işlenmesine ilişkin amaç ve vasıtaları belirleyen veri sorumlusu sıfatıyla hareket eden tüzel kişi bilgileri aşaÃ„şıda sunulmaktadır:
                            </p>
                            <div style={{
                        ...
                        <div data-section="kapsam" className="legal-section">
                            ...
                            <p className="legal-p">
                                Bu Gizlilik Politikası, www.Otosöz.com web sitesi, mobil uygulamaları ve tüm dijital uzantıları aracılıÃ„şıyla toplanan kişisel verilerin; nasıl toplandıÃ„şını, hangi amaçlarla işlendiğini, kimlere ve hangi koşullarla aktarılabileceÃ„şini ve veri sahiplerinin KVKK kapsamındaki haklarını düzenler.
                            </p>
                            <p className="legal-p">
                        ...
                        <div data-section="toplanan-veriler" className="legal-section">
                            ...
                            <p className="legal-p">KVKK m.3/d tanımına istinaden, aşaÃ„şıdaki kategorilerdeki kişisel veriler işlenmektedir:</p>
                            ...
                            <div className="legal-highlight" style={{
                                ...
                                <span style={{ color: 'var(--text-muted)' }}>
                                    KVKK m.6 kapsamında tanımlanan özel nitelikli kişisel veriler (ırk, saÃ„şlık, biyometrik vb.) Platform tarafından hiçbir koşulda toplanmaz ve işlenmez.
                                </span>
                            </div>
                        </div>
                        ...
                        <div data-section="isleme-amaci" className="legal-section">
                            ...
                            <p className="legal-p">KVKK m.5 ve m.6 çerçevesinde kişisel verileriniz aşaÃ„şıdaki amaçlarla işlenmektedir:</p>
                            <ul className="legal-list">
                                <li><strong style={{ color: 'var(--foreground)' }}>Üyelik İŞlemleri:</strong> Hesap oluşturma, kimlik doÃ„şrulama ve oturum yönetimi.</li>
                                <li><strong style={{ color: 'var(--foreground)' }}>Hizmet Sunumu:</strong> Platform hizmetlerinin (forum, pazar, karşılaştırma vb.) saÃ„şlanması ve kişiselleştirilmesi.</li>
                                <li><strong style={{ color: 'var(--foreground)' }}>İletişim:</strong> Bildirimler, duyurular ve destek taleplerinin yönetimi.</li>
                                <li><strong style={{ color: 'var(--foreground)' }}>Güvenlik:</strong> Platform güvenliÃ„şinin saÃ„şlanması, kötüye kullanımın ve yetkisiz erişimin önlenmesi.</li>
                                ...
                                <li><strong style={{ color: 'var(--foreground)' }}>Meşru Menfaat:</strong> Dolandırıcılık tespiti, sistem saÃ„şlıÃ„şı izleme ve hizmet iyileştirme.</li>
                            </ul>
                        </div>
                        ...
                        <div data-section="hukuki-sebepler" className="legal-section">
                            ...
                            <p className="legal-p">Kişisel verileriniz KVKK m.5/2 kapsamında aşaÃ„şıdaki hukuki sebeplere dayanarak işlenmektedir:</p>
                            <ul className="legal-list">
                                ...
                                <li><strong style={{ color: 'var(--foreground)' }}>m.5/2-c:</strong> Bir sözleşmenin kurulması veya ifasıyla doÃ„şrudan ilgili olması (üyelik sözleşmesi kapsamındaki hizmetlerin sunulması).</li>
                                <li><strong style={{ color: 'var(--foreground)' }}>m.5/2-ç:</strong> Veri sorumlusunun hukuki yükümlülüÃ„şünü yerine getirebilmesi.</li>
                                ...
                                <li><strong style={{ color: 'var(--foreground)' }}>m.5/1:</strong> Belirtilen sebeplerin mevcut olmadıÃ„şı hallerde, açık rızanızın alınması.</li>
                            </ul>
                        </div>
                        ...
                        <div data-section="veri-paylasimi" className="legal-section">
                            ...
                            <p className="legal-p">
                                Kişisel verileriniz, KVKK m.8 ve m.9 hükümleri çerçevesinde ve yalnızca aşaÃ„şıda belirtilen taraflarla, belirtilen amaçlarla sınırlı olarak paylaşılabilir:
                            </p>
                            <ul className="legal-list">
                                ...
                                <li><strong style={{ color: 'var(--foreground)' }}>Teknik Hizmet SaÃ„şlayıcıları:</strong> Sunucu barındırma, CDN ve analitik hizmetleri sunan iş ortakları (veri işleyen sıfatıyla, veri işleme sözleşmesi kapsamında).</li>
                            ...
                            <div className="legal-highlight" style={{
                                ...
                                <span style={{ color: 'var(--text-muted)' }}>
                                    Kişisel verileriniz hiçbir koşulda üçüncü taraf reklam Şirketlerine satılmaz, kiralanmaz veya ticari amaçla paylaşılmaz. Yurt dışına veri aktarımı yapılması halinde KVKK m.9 hükümlerine tam uyum saÃ„şlanır.
                                </span>
                            </div>
                        </div>
                        ...
                        <div data-section="veri-guvenligi" className="legal-section">
                            <h2 className="legal-h2">
                                ...
                                Veri GüvenliÃ„şi Tedbirleri
                            </h2>
                            <p className="legal-p">
                                KVKK m.12 uyarınca kişisel verilerinizin güvenliÃ„şi için aşaÃ„şıdaki idari ve teknik tedbirler uygulanmaktadır:
                            </p>
                            ...
                            <ul className="legal-list">
                                ...
                                <li><strong style={{ color: 'var(--foreground)' }}>Yedekleme:</strong> Düzenli, Şifreli yedekler coÃ„şrafi olarak ayrılmış sunucularda saklanır.</li>
                            </ul>
                            <h3 className="legal-h3">8.2 İdari Tedbirler</h3>
                            <ul className="legal-list">
                                <li>Erişim yetkilendirme matrisi (en az yetki prensibi).</li>
                                <li>Çalışan gizlilik sözleşmeleri ve düzenli veri koruma eÃ„şitimleri.</li>
                        ...
                        <div data-section="ilgili-haklari" className="legal-section">
                            ...
                            <p className="legal-p">KVKK m.11 uyarınca, kişisel veri sahibi olarak aşaÃ„şıdaki haklara sahipsiniz:</p>
                            <ul className="legal-list">
                                <li><strong style={{ color: 'var(--foreground)' }}>Bilgi Talep Hakkı:</strong> Kişisel verilerinizin işlenip işlenmediğini öÃ„şrenme.</li>
                                <li><strong style={{ color: 'var(--foreground)' }}>Bilgi Edinme Hakkı:</strong> İŞlenmişse buna ilişkin bilgi talep etme.</li>
                                <li><strong style={{ color: 'var(--foreground)' }}>Amaç ÖÃ„şrenme Hakkı:</strong> İŞlenme amacını ve amacına uygun kullanılıp kullanılmadıÃ„şını öÃ„şrenme.</li>
                                <li><strong style={{ color: 'var(--foreground)' }}>Aktarım Bilgisi Hakkı:</strong> Yurt içinde veya yurt dışında aktarıldıÃ„şı üçüncü kişileri bilme.</li>
                                ...
                                <li><strong style={{ color: 'var(--foreground)' }}>Tazminat Hakkı:</strong> Kanuna aykırı işleme nedeniyle zarara uÃ„şranması halinde zararın giderilmesini talep etme.</li>
                            </ul>
                        ...
                        <div data-section="degisiklikler" className="legal-section">
                            ...
                            <p className="legal-p">
                                Platform, bu Gizlilik Politikası&#39;nı yasal düzenlemelerdeki değişikliklere, teknolojik gelişmelere veya iç politika güncellemelerine baÃ„şlı olarak güncelleme hakkını saklı tutar. Esaslı değişikliklerde kullanıcılara e-posta ve platform içi bildirim yoluyla bilgilendirme yapılır.
                            </p>
                            <p className="legal-p">
                        ...
                        <div data-section="iletisim" className="legal-section">
                            ...
                            <div className="legal-highlight" style={{
                                ...
                                <span style={{ color: 'var(--text-muted)' }}>
                                    Otosöz olarak, kişisel verilerinizin korunması konusundaki sorumluluÃ„şumuzu en üst düzeyde tutuyoruz.
                                    KVKK ve ilgili mevzuata tam uyum saÃ„şlamayı ve veri güvenliÃ„şi standartlarımızı sürekli iyileştirmeyi taahhüt ediyoruz.
                                </span>
                            </div>
